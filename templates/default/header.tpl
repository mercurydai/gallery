{*
  ...
  $Id: header.tpl,v 2.12 2007/12/03 20:05:27 andig2 Exp $
*}
...
<table width="100%" class="menutable">
  <tr>
	...
	<td width="100%" valign="bottom" align="center" style="text-align:center">
	  ...
	  {if $header.del != ''}[&nbsp;<a href="{$header.del}" onclick="return(confirm('{$lang.really_del|escape:javascript|escape}?'))">{$lang.del}</a>&nbsp;] {/if}
