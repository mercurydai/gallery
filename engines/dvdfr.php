 ...
 * @version $Id: dvdfr.php,v 1.6 2010/02/18 15:17:25 andig2 Exp $
 */
...
function dvdfrData($imdbID) 
{
    ...
    $data['title']    = mb_convert_case(dvdfrCleanStr($ary[1]), MB_CASE_TITLE);
    $data['subtitle'] = mb_convert_case(dvdfrCleanStr($ary[2]), MB_CASE_TITLE);
