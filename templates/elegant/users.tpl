{*
  ...
  $Id: users.tpl,v 1.8 2007/12/03 20:05:31 andig2 Exp $
*}
	...
	{foreach item=user from=$userlist}
		<tr class="{cycle values="even,odd"}">
			...
			<td class="center">
				...
				{if !$user.guest}
				<input type="submit" class="button" value="{$lang.del}" onClick="return confirm('{$lang.really_del|escape:javascript|escape}?')" />
				{/if}
				</form>
			</td>
			<td class="center">
