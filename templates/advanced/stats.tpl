{*
  ...
  $Id: stats.tpl,v 1.7 2008/11/13 17:56:05 andig2 Exp $
*}
          ...
          <td>
            <table cellpadding="2">
              <tr valign="top">
                ...
                {foreach key=year item=count from=$stats.count_year}<a href="search.php?q={$year}&amp;fields=year&amp;nowild=1"><img src="images/bar.gif" width="7" height="{math equation="round(80/y*x)" x=$count y=$stats.max_count}" title="{$year}: {$count}" alt="{$year}: {$count}" border="0" /></a>{/foreach}
                </td>
