{*
  ...
  $Id: users.tpl,v 1.11 2007/12/03 20:05:29 andig2 Exp $
*}
...
<table width="100%" class="tableborder">
  ...
  {foreach item=user from=$userlist}
    ...
    <td align="left" style="text-align:left">
      ...
      <td align="center" style="text-align:center">
        {if !$user.guest}
        <a href="users.php?del={$user.id|escape:url}" onClick="return confirm('{$lang.really_del|escape:javascript|escape}?')">{$lang.del}</a>
        {else}
        &nbsp;
        {/if}
      </td>
