{*
  ...
  $Id: list.tpl,v 2.17 2008/01/08 08:56:15 andig2 Exp $
*}
    ...
    {/foreach}
      ...
      <td align="center" nowrap="nowrap" style="text-align:center">
        {if $video.editable}
          ...
          <a href="delete.php?id={$video.id}" onclick="return(confirm('{$video.title|escape:javascript|escape}: {$lang.really_del}?'))">{$lang.del}</a>
        {/if}
      </td>
